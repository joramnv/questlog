...
public class UserPasswordRepositoryIT extends AbstractQuestlogApplicationIT {
	...
	public void shouldReturnRepositoryIndex() throws Exception {
		mockMvc.perform(get("/userPasswords")).andDo(print()).andExpect(status().isOk()).andExpect(
